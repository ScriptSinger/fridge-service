...
<article x-data="{ modal: false }"
    class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition duration-300 p-6 h-full flex flex-col justify-between cursor-pointer"
