<button x-data="{ show: false }" x-cloak x-show="show" style="display: none;" x-transition
    ...
    class="fixed bottom-20 right-3 p-4 bg-yellow-500 text-white rounded-full shadow-lg hover:bg-yellow-600 hover:scale-110 transition transform duration-300 cursor-pointer"
