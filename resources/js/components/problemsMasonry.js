export default function problemsMasonry() {
    return {
        resizeTimer: null,
        layoutTimer: null,
        onResize: null,
        ...
        getGap(container) {
            ...
            const raw = (computed.getPropertyValue("--problems-masonry-gap") || "32px").trim();
        ...
        bindRefreshListener() {
            this.onRefresh = () => this.scheduleLayout();
            this.$el.addEventListener("masonry:refresh", this.onRefresh);
        },
        ...
        destroy() {
            ...
            if (this.onRefresh) {
                this.$el.removeEventListener("masonry:refresh", this.onRefresh);
            }
