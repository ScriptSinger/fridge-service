...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['devices']));
...
foreach (array_filter((['devices']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.sections.header','data' => ['title' => 'Примерные цены на ремонт бытовой техники','subtitle' => 'Выберите тип техники, чтобы посмотреть ориентировочные цены']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Примерные цены на ремонт бытовой техники','subtitle' => 'Выберите тип техники, чтобы посмотреть ориентировочные цены']); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-4">
        <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <details class="group rounded-lg border border-gray-200 bg-white" <?php if($loop->first): ?> open <?php endif; ?>>
                <summary class="cursor-pointer list-none px-4 py-3 flex items-center justify-between">
                    <span class="font-semibold text-gray-900"><?php echo e($device->type); ?></span>
                    <span class="text-gray-500 transition-transform duration-200 group-open:rotate-180">⌄</span>
                </summary>

                <div class="px-4 pb-4">
                    <div class="hidden md:block">
                        <?php echo $__env->make('components.sections.prices.table', [
                            'services' => $device->services,
                        ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>

                    <div class="md:hidden">
                        <?php echo $__env->make('components.sections.prices.mobile', [
                            'services' => $device->services,
                        ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/sections/prices/index.blade.php ENDPATH**/ ?>