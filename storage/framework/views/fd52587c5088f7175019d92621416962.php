...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page?->title ?? 'Контакты'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page?->description ?? 'Контакты сервиса ремонта бытовой техники.')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.breadcrumbs','data' => ['route' => 'contacts.index','model' => null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['route' => 'contacts.index','model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(null)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sections.hero','data' => ['model' => $page,'h1' => ''.e($page?->h1 ?? 'Контакты').'','subtitle' => ''.e($page?->subtitle ?? 'Адрес, телефон и форма для связи.').'','containerClass' => 'pt-9']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page),'h1' => ''.e($page?->h1 ?? 'Контакты').'','subtitle' => ''.e($page?->subtitle ?? 'Адрес, телефон и форма для связи.').'','containerClass' => 'pt-9']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/pages/contacts.blade.php ENDPATH**/ ?>