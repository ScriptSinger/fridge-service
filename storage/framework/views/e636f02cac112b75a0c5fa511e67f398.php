...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['variant' => 'header']));
...
foreach (array_filter((['variant' => 'header']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/ui/phone-cta.blade.php ENDPATH**/ ?>