    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div
            ...
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
                <?php echo e($service->h1 ?? $service->title); ?>

            </h1>
            <p class="mb-8 leading-relaxed "> <?php echo e($service->excerpt ?? Str::limit($service->description, 120)); ?></p>
...
<?php /**PATH /var/www/html/resources/views/components/sections/service/hero.blade.php ENDPATH**/ ?>